...
### ResultAndOptionAnalyzers.Sample
A project that references the sample analyzers. Note the parameters of `ProjectReference` in [ResultAndOptionAnalyzers.Sample.csproj](../ResultAndOptionAnalyzers.Sample/ResultAndOptionAnalyzers.Sample.csproj), they make sure that the project is referenced as a set of analyzers. 

### ResultAndOptionAnalyzers.Tests

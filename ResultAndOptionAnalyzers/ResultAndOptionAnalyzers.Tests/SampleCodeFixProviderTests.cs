...
using Xunit;
using Verifier =
    Microsoft.CodeAnalysis.CSharp.Testing.XUnit.CodeFixVerifier<ResultAndOptionAnalyzers.SampleSyntaxAnalyzer,
        ResultAndOptionAnalyzers.SampleCodeFixProvider>;

namespace ResultAndOptionAnalyzers.Tests;

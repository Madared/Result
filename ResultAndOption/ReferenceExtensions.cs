...
public static class ReferenceExtensions {
    ...
    /// <returns>
    ///     A result of type <typeparamref name="TOut" /> produced by the function if the input reference is not null.
    ///     Otherwise, a failed result with an unknown error is returned.
    /// </returns>
    ...
    /// <param name="function">The function to invoke on the input reference.</param>
    /// <returns>
    ///     The result of type <typeparamref name="TOut" /> produced by the function if the input reference is not null.
    ...
    public static TOut PipeNonNull<TIn, TOut>(this TIn i, Func<TIn, TOut> function) where TIn : notnull {
        return function(i);
    }
    ...
    /// <returns>
    ///     A result produced by the function if the input reference is not null. Otherwise, a failed result with the

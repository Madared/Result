...
public static class Mapping {
    ...
    /// <returns></returns>
    public static Option<TOut> Map<T, TOut>(this Option<T> option, Func<T, TOut> function) where T : notnull where TOut : notnull => option.IsNone()
        ? Option<TOut>.None()
    ...
    /// <param name="function">mapping function</param>
    /// <returns></returns>
    public static Option<TOut> Map<T, TOut>(this Option<T> option, Func<T, Option<TOut>> function) where T : notnull where TOut : notnull => option.IsNone()
        ? Option<TOut>.None()
